...
# source: protobuf/google/api.proto
...
from protobuf.google import source_context_pb2 as protobuf_dot_google_dot_source__context__pb2
from protobuf.google import type_pb2 as protobuf_dot_google_dot_type__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='protobuf/google/api.proto',
...
_API.fields_by_name['options'].message_type = protobuf_dot_google_dot_type__pb2._OPTION
_API.fields_by_name['source_context'].message_type = protobuf_dot_google_dot_source__context__pb2._SOURCECONTEXT
_API.fields_by_name['mixins'].message_type = _MIXIN
_API.fields_by_name['syntax'].enum_type = protobuf_dot_google_dot_type__pb2._SYNTAX
_METHOD.fields_by_name['options'].message_type = protobuf_dot_google_dot_type__pb2._OPTION
_METHOD.fields_by_name['syntax'].enum_type = protobuf_dot_google_dot_type__pb2._SYNTAX
...
Api = _reflection.GeneratedProtocolMessageType('Api', (_message.Message,), dict(
  DESCRIPTOR = _API,
  __module__ = 'protobuf.google.api_pb2'
